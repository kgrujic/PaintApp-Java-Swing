...
/*
 *	Added an Action to a JList that can be invoked either by using
...
public class ListAction implements MouseListener
{
    ...
    /*
     *	Added an Action to the JList bound by the default KeyStroke
     */
    ...
    /*
     *	Added an Action to the JList bound by the specified KeyStroke
     */
    public ListAction(JList list, Action action, KeyStroke keyStroke)
    {
        ...
        //  Added the KeyStroke to the InputMap

        InputMap im = list.getInputMap();
        im.put(keyStroke, keyStroke);

        //  Added the Action to the ActionMap
